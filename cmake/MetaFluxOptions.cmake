...
option(METAFLUX_BUILD_CUBLAS_PROVIDER "Build the cuBLAS compatibility provider" ON)
...
option(METAFLUX_BUILD_VROOT_MODEL "Build the host-independent experimental vroot model" ON)
...
if(METAFLUX_BUILD_CUBLAS_PROVIDER AND NOT METAFLUX_BUILD_CUDA_DRIVER_PROVIDER)
  message(FATAL_ERROR "METAFLUX_BUILD_CUBLAS_PROVIDER requires METAFLUX_BUILD_CUDA_DRIVER_PROVIDER")
endif()

if(
  (METAFLUX_BUILD_CUDA_DRIVER_PROVIDER OR METAFLUX_BUILD_CUBLAS_PROVIDER OR METAFLUX_BUILD_NVML_PROVIDER)
  AND NOT METAFLUX_BUILD_CLIENT_FASTPATH
)
  message(FATAL_ERROR "CUDA/cuBLAS/NVML providers require METAFLUX_BUILD_CLIENT_FASTPATH")
endif()
