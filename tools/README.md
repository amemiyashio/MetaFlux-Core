...
the action set, repository-path confinement, host authorization, and failure
classification; the invoked package, Kbuild, test, or qualification workflow
retains its own semantics and evidence.
