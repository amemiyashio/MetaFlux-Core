...
_Static_assert(MF_CLIENT_KERNEL_REQUEST_OPERATION_MATMUL_F32_V1 == UINT32_C(31),
               "matmul-f32 operation");
_Static_assert(MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_CLAMP_MIN_F32_V1 == UINT32_C(32),
