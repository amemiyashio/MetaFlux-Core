...
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_SUB_I32_V1 UINT32_C(3)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_ADD_F32_V1 UINT32_C(4)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_MUL_F32_V1 UINT32_C(5)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_DIV_F32_V1 UINT32_C(6)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_NEG_I32_V1 UINT32_C(7)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_FILL_I32_V1 UINT32_C(8)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_SCALAR_ADD_I32_V1 UINT32_C(9)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_SCALAR_MUL_I32_V1 UINT32_C(10)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ALPHA_ADD_I32_V1 UINT32_C(11)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_ABS_I32_V1 UINT32_C(12)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_ABS_F32_V1 UINT32_C(13)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_SQRT_F32_V1 UINT32_C(14)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_COMPARE_EQ_I32_V1 UINT32_C(15)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_COMPARE_GT_I32_V1 UINT32_C(16)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_COMPARE_LT_F32_V1 UINT32_C(17)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_CAST_COPY_I64_V1 UINT32_C(18)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_REDUCE_SUM_I32_V1 UINT32_C(19)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_REDUCE_SUM_F32_V1 UINT32_C(20)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_REDUCE_MEAN_F32_V1 UINT32_C(21)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_REDUCE_MAX_I32_V1 UINT32_C(22)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_REDUCE_MIN_I32_V1 UINT32_C(23)
...
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_SUB_F32_V1 UINT32_C(28)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_RELU_F32_V1 UINT32_C(29)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_SOFTMAX_F32_V1 UINT32_C(30)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_MATMUL_F32_V1 UINT32_C(31)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_CLAMP_MIN_F32_V1 UINT32_C(32)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_SOFTMAX_DIM_F32_V1 UINT32_C(33)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_SIGMOID_F32_V1 UINT32_C(34)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_CLAMP_MIN_I32_V1 UINT32_C(35)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ARANGE_I64_V1 UINT32_C(36)
#define MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_EXP_F32_V1 UINT32_C(37)
...
static inline uint32_t mf_client_kernel_request_validate_v1(const uint8_t* payload,
  ...
  if (payload == (const uint8_t*)0 || byte_count < MF_CLIENT_KERNEL_REQUEST_HEADER_SIZE_V1 ||
      ...
      (mf_client_load_le32_v1(request->bytes + 20) !=
       ...
       mf_client_load_le32_v1(request->bytes + 20) !=
               MF_CLIENT_KERNEL_REQUEST_OPERATION_CLAMP_MIN_I32_V1 &&
       mf_client_load_le32_v1(request->bytes + 20) !=
           MF_CLIENT_KERNEL_REQUEST_OPERATION_ARANGE_I64_V1 &&
       mf_client_load_le32_v1(request->bytes + 20) !=
           MF_CLIENT_KERNEL_REQUEST_OPERATION_ELEMENTWISE_EXP_F32_V1) ||
