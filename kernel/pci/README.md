...
owned by the PCI MSI-X capability; the driver registers one bounded IRQ handler
per vector and records delivered notifications without exposing a new UAPI. The
driver does not implement NVIDIA RM/UVM behavior.
