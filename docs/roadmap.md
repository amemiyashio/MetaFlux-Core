...
## Vulkan Execution Backend (`plugins/backend/vulkan/`, M0004)

The Vulkan backend is a planned v0.2 execution backend behind the same
versioned backend C ABI as the CPU backend. It owns Vulkan capability
...
## vfio-user Service (`services/metaflux-vfio-userd/`, M0002)
...
## Compiler Worker (`services/compiler-worker/`, M0001)
