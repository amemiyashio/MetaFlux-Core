...
floor. D0009, durable constraints, the M0001 plan, current progress, and the
test comment already agreed; M0001-W01 alone still described glibc 2.31 as a
candidate pending the broader distribution matrix.

The corrected W01 separates two concerns:
