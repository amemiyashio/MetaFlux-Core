...
probe without changing M0100 product claims. The baseline is PyTorch
...
- `agent/plan/pytorch-compatibility-roadmap.md` and `manage-toolchain`: preserve
  the M0100/D0017 boundary and govern exact framework-client profiles.
...
- `sm_80` publication remains future-milestone work. The frontier profile does
  not change D0017, capability negotiation, provider identity, or M0100 scope.
