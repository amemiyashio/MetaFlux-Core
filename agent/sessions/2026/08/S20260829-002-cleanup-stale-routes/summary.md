...
- `tests/`, M0001 W06, and the CPU performance reference: assign build, test,
  PGO evidence, and benchmark ownership to their actual CMake/CTest/test and
  packaging workflows.
- M0003 W01 and its lifecycle skill reference: write model evidence under the
...
- M0001-W01 and M0001-W06 remain active: release matrices, stock-tool runs,
...
Read [current progress](../../../../progress/current.md), D0022, M0001, and the
