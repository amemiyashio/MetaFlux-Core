...
- W0101: add a checked-in CMake-owned target toolchain/preset or build
  driver that selects the complete documented tuple from a fresh build tree.
- W0101: add a checked-in driver for the complete signed-provenance verifier
  argument set and wire it into the appropriate qualification owner.
- W0101/W0106: package and run the full digest-pinned release matrix twice
