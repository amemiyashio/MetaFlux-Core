...
rewritten as a curated work ledger with an explicit cleanup phase, while M0001
and W01 were reduced to task and acceptance definitions that consume the
...
- `agent/memory/`, M0001/W01, and queued release work items: recorded D0022 and
...
| M0001 optimization and performance runner self-tests | 12/12 and 12/12 passed |
...
- S20260828-013 and M0001-W01 remain active. This correction does not promote
  the in-progress implementation to release-qualified status.
...
materialization changes, and continue S20260828-013 through the owner-specific
CMake/CTest/packaging gates. Use `nix develop . --command <owner command>` and
remove exact session-owned external work directories at handoff.
