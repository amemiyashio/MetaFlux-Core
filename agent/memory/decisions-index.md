...
| D0029 | One Exit-Gate-bound execution focus and exact owner session authorize durable content commits | [Execution focus governance](../../docs/architecture/execution-focus-governance.md) | Verified architecture at `47d5735`; final record handoff tracked by Active SC0006 |
