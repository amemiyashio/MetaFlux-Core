...
| decision-0034 | Agent identity comes from bounded harness/CLI executable detection and never from model metadata | [Agent tool detection](../../docs/architecture/agent-tool-detection.md) | Verified; adopted during epoch-0002 governance; current epoch is epoch-0006 |
| decision-0035 | Epoch-0003 governance: remove stale out-of-repository worktrees, advance Epoch, and continue non-1.0 plan completion with deferred lane carried forward | [agent/goal.json](../goal.json) | Completed governance; superseded by later Epochs; current epoch is epoch-0006 |
