...
| decision-0034 | Agent identity comes from bounded harness/CLI executable detection and never from model metadata | [Agent tool detection](../../docs/architecture/agent-tool-detection.md) | Verified; adopted during epoch-0002 governance; current epoch is epoch-0007 |
| decision-0035 | Epoch-0003 governance: remove stale out-of-repository worktrees, advance Epoch, and continue non-1.0 plan completion with deferred lane carried forward | [agent/goal.json](../goal.json) | Completed governance; superseded by later Epochs; current epoch is epoch-0007 |
| decision-0036 | Tool provisioning is a resolvable task, not a blocker: when a required tool is absent, always attempt Nix then manage-host-privilege/pacman before declaring inability to proceed | [AGENTS.md](../../AGENTS.md) rule 7, [manage-host-privilege](../skills/manage-host-privilege/SKILL.md), [constraints](constraints.md) | Active; prevents agents from treating missing tools as absolute blockers |
| decision-0037 | Epoch-0005 governance: product source and test CRUD prefer a parent briefing, a bounded coding subagent, and parent review against drift; the parent remains sole owner of goal.json, verification, commit, integrate, and govern | [Goal-first execution](../../docs/architecture/agent-execution.md), [start-work](../skills/start-work/SKILL.md) | Active; replaces the epoch-0004 read-only-only subagent default |
| decision-0038 | Epoch-0006 governance: after an Epoch activation commit or a Batch integration commit that updated goal.json is on disk, the parent pushes that full object ID through push-repository; ordinary Iteration commits do not push | [Push repository](../skills/push-repository/SKILL.md), [AGENTS.md](../../AGENTS.md) rule 10 | Active; replaces the epoch-0005 never-infer-push default for Epoch and Batch only |
| decision-0039 | Epoch-0007 governance: the parent does not start the next coding-subagent dispatch or Iteration cycle until conversational review accepts the dispatched briefing goal without drift | [start-work](../skills/start-work/SKILL.md), [Goal-first execution](../../docs/architecture/agent-execution.md) | Active; serializes briefing, dispatch, review, then the next cycle |
