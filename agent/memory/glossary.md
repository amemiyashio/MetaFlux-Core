...
| Logical device | Stable MetaFlux-visible compute identity presented consistently through enabled interfaces | [W0102](../plan/M0100-core-foundation/work/W0102-contracts-runtime.md) |
...
| Generation | Monotonic incarnation of a logical device; stale objects retain their old generation and fail deterministically | [M0120](../plan/M0120-vpci-lifecycle/plan.md) |
| Epoch | Persistent monotonic retirement counter advanced by checked addition exactly once per committed retirement; exhaustion never wraps | [W0121](../plan/M0120-vpci-lifecycle/work/W0121-lifecycle-model.md) |
| Lifecycle sequence | View-scoped no-wrap serial published through a FIFO range gate; only the head range writes, unused suffixes retire permanently, and `UINT64_MAX` closes the process mapping | [W0102](../plan/M0100-core-foundation/work/W0102-contracts-runtime.md) |
...
| AOT | Compilation completed before first execution and loaded from a compatible artifact/cache entry | [W0103](../plan/M0100-core-foundation/work/W0103-compiler-cpu.md) |
| JIT | Compilation performed on demand after a cache miss; cache-hit execution avoids the compiler service | [W0103](../plan/M0100-core-foundation/work/W0103-compiler-cpu.md) |
...
| vPCI | Virtual PCI presentation and transport mechanism; not vendor-private GPU emulation | [M0120](../plan/M0120-vpci-lifecycle/plan.md) |
