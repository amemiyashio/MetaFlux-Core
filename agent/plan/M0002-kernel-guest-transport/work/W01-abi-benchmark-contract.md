...
| Path | Ownership |
| --- | --- |
| `contracts/plugin/backend/v1/` | M0001 backend C function table |
| `contracts/protocol/client/v1/` | M0001 provider/client negotiation |
...
start at ABI `0.x`; the inherited M0001 descriptor is already frozen. v1 freezes
