...
M0002 leaves `VFIO_DEVICE_FLAGS_RESET` clear in `VFIO_USER_DEVICE_GET_INFO` and
...
needs a fresh static instance. M0003 may advertise coordinated reset only after
