...
release: v0.2.3
status: Queued
depends_on: [M0002, M0003]
areas: [backend.vulkan, compiler.spirv]
updated: 2026-08-27
---

# M0004: Vulkan Execution Backend
...
remain the application-facing compatibility APIs. M0002 owns the data plane and
M0003 owns lifecycle; this milestone consumes both contracts.
...
Development may begin after [M0002](../M0002-kernel-guest-transport/plan.md)
stabilizes the backend and transport ABIs. Release requires the
[M0003](../M0003-vpci-lifecycle/plan.md) core Definition of
...
| --- | --- |
| [M0004-W01](work/W01-capability-abi.md) | Vulkan target, capability/argument/memory ABI 0.x, and benchmark fixtures |
| [M0004-W02](work/W02-device-memory.md) | Device/queue bring-up, memory tiers, synchronization, and lifecycle hooks |
| [M0004-W03](work/W03-spirv-lowering.md) | Target-constrained lowering, validation, reflection, and semantic diagnostics |
| [M0004-W04](work/W04-execution-streams.md) | Pipeline execution and CUDA-observable stream/event behavior |
| [M0004-W05](work/W05-cache-warm-path.md) | Portable/device caches and compile-free warm launch |
| [M0004-W06](work/W06-performance-release.md) | Performance, faults, packaging, and release qualification |
...
- Warm provider enqueue retains M0002 bounds.
...
- M0003 lifecycle core remains inside its 0.5% steady-state budget. Experimental
...
- Cache corruption, import/compiler failure, and driver change recover or fail
  deterministically.
- M0001, M0002, and M0003 core remain green with Vulkan installed but idle.
...
and reconvergence uncertainty. It adds no runtime UAPI and blocks neither M0004
nor later semantic work.

## Definition of Done

M0004 is complete when the M0003 lifecycle core remains green without transport
...
M0004-W01 through W05 may proceed after M0002. Vulkan-specific release
integration waits for the M0003 core DoD and all gates above. Deferred cubin
