...
Apply one generation transaction to the milestone-0.1.0.0 memfd fallback, milestone-0.1.1.0 local cdev,
and milestone-0.1.1.0 guest vfio-user paths without changing the milestone-0.1.1.0 descriptor, base
...
CUDA and NVML retain the milestone-0.1.0.0 provider-view epoch and shared
...
not include milestone-0.1.1.0 descriptors, ioctl/mmap records, BAR definitions, QMP types,
or provider APIs.
