...
milestone, product support promise, or acceptance gate for M0001.

## Client Profiles

| Profile | Pinned client | Purpose | Product boundary |
| --- | --- | --- | --- |
| `pytorch-baseline` | PyTorch `2.11.0+cu126` | Observe the current `sm_70` path and retain a stable comparison point. | Reports gaps only; it does not expand D0017 or M0001. |
...
[M0001](M0001-core-foundation/plan.md) remains on its frozen PTX 9.0/`sm_70`
...
milestone rather than being folded into M0001.
