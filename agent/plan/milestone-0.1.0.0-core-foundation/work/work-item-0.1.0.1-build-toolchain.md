...
Prove that milestone-0.1.0.0 can be configured, built, tested, and packaged with the
...
The milestone-0.1.0.0 language and closure tasks remain: providers and the client fast path
...
## Release Qualification Matrix (decision-0012)

milestone-0.1.0.0 / `v0.1.0` qualifies the following release rows. Image, kernel,
...
- [x] Emit build manifests containing the compiler epoch inputs used by each
  relevant artifact.
- [x] Qualify the decision-0018 LLVM correctness patch and reproducer and the decision-0016
...
- [x] Qualify the milestone-0.1.0.0 AMD x86_64 build/reference host. AMD Ryzen 7 H 255
  passed the recorded integration suite and decision-0015 placement checks.
- [x] Execute every decision-0012 install, upgrade, removal, closure, and coexistence row
