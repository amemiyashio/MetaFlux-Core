...
status: Queued
budgets: provisional
depends_on: [M0100, M0110, M0120, M0130]
areas: [build, backend.cpu, compat.cuda, performance, release]
updated: 2026-08-30
---

# M1000: Stable Host and Binding Qualification
...
`v0.1.x` product line; it does not move either hardware gate back into M0100.
...
## Release Boundary Decision (D0027)

D0027 assigns Intel x86_64 support qualification and physical NVIDIA
binding-performance promotion to M1000 / `v1.0.0`. It supersedes D0023 only for
the future Intel destination and supersedes D0024 only for the former assignment
of those two gates to `v0.2.0`. M0100 still closes against its AMD x86_64
reference evidence and provisional budgets. D0012 still assigns native NixOS
...
- Treating a missing physical field, skipped binding row, or provisional M0100
...
| --- | --- | --- |
| [W1001](work/W1001-intel-host-support.md) | Queued | Intel x86_64 host support and qualification |
| [W1002](work/W1002-nvidia-binding-performance.md) | Queued | Physical NVIDIA binding evidence and budget promotion |
| [W1003](work/W1003-stable-release.md) | Queued | Stable compatibility contract and reproducible v1.0.0 release |
...
- The canonical performance budgets become `binding` only after W1002 passes;
  M0100 historical observations remain provisional evidence for their own
  revisions.
...
M1000 / `v1.0.0` is complete only when W1001-W1003 exit gates pass from named
