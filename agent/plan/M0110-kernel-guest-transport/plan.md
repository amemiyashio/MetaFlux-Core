...
# M0110: Kernel and Guest Transport

## Outcome

Prove local cdev and static QEMU/KVM vfio-user data paths with the M0100 CPU
...
[M0100](../M0100-core-foundation/plan.md) identity/view, 64-byte descriptor,
...
M0110 implements their local broker and guest transport consequences without
...
- `contracts/protocol/transport/v1/schema/manifest.json` is the sole M0110
...
- Static guest cold-plug and terminal reset-to-`LOST` are included. M0110 leaves
  ...
  bare-metal software PCI move to [M0120](../M0120-vpci-lifecycle/plan.md).
...
| --- | --- |
| [W0111](work/W0111-abi-benchmark-contract.md) | ABI 0.x fixtures, UAPI boundary, endian adaptation, and benchmark definition |
| [W0112](work/W0112-local-cdev.md) | Local cdev Add/Copy and exclusive worker broker |
| [W0113](work/W0113-static-vfio-user.md) | Static guest PCI, DMA, BAR, ioeventfd/MSI-X Add/Copy |
| [W0114](work/W0114-fault-abi-freeze.md) | Fault qualification and data-plane v1 freeze |
| [W0115](work/W0115-performance-release.md) | Performance, packaging, and release hardening |

## Milestone Acceptance

Correctness and ABI:

- Local cdev and guest Add/Copy agree with M0100.
...
- Vendor files/nodes remain untouched. Generic packages have no required
  ...
  checks.
- M0100 remains green with M0110 installed but idle.
...
M0110 is complete when both CPU Add/Copy slices pass; the qualified transport
...
performance/package gates and raw evidence pass; and M0100 stays green.

M0120 may then extend lifecycle/admin behavior without changing M0110 data-plane
