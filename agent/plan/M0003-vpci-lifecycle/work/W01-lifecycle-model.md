...
The extension manifest imports the frozen M0002 root manifest by path, version,
and content hash. The dependency is one-way: the M0002 root never imports the
extension, so adding lifecycle leaves every frozen M0002 definition and root
