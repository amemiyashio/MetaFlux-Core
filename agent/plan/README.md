...
| [milestone-0.2.0.0](milestone-0.2.0.0-pytorch-cuda-compatibility/plan.md) | 0.2.0.0 | v0.2.0 | Active | PyTorch CUDA transparent compatibility foundation (the reserved NixOS expansion moves to v0.3.0) |
