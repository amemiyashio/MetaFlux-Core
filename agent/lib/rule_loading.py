...
OWNERS = {
    "runtime-contracts-registry": ("runtime/core/", "contracts/protocol/", "contracts/shared/", "contracts/plugin/"),
    "cuda-driver-abi-compatibility": ("plugins/compat/cuda/abi/",),
    "pytorch-cuda-profile": (
        "plugins/compat/cuda/abi/driver/src/provider.c",
        "plugins/compat/cuda/abi/driver/profiles/",
        "tests/compatibility/pytorch_cuda_cpu_frontier_corpus_v1.json",
        "tests/compatibility/pytorch_cuda_probe.py",
        "tests/compatibility/run_pytorch_cuda_stock_baseline.py",
        "tests/compatibility/test_pytorch_cuda_stock_baseline.py",
        "tests/compatibility/run_pytorch_cuda_cpu_frontier.py",
        "tests/compatibility/test_pytorch_cuda_cpu_frontier.py",
        "tests/compatibility/run_pytorch_cuda_matmul_admission.py",
        "tests/compatibility/run_pytorch_cuda_cat.py",
        "tests/compatibility/test_pytorch_cuda_cat.py",
        "tests/compatibility/test_pytorch_cuda_probe.py",
        "tools/check-pytorch-cuda-readiness.py",
    ),
    "cublas-compatibility": ("plugins/compat/cuda/libraries/cublas/",),
    "process-activation": (
        "plugins/compat/cuda/passthrough/",
        "packaging/common/metafluxd.service", "packaging/common/metafluxd.socket",
        "packaging/common/vendor-libraries.conf.example",
        "tests/release/metaflux_activation_launcher.c",
    ),
    "daemon-execution-runtime": (
        "runtime/client/fastpath/",
        "services/metafluxd/src/server.cpp", "services/metafluxd/src/server.hpp",
        "services/metafluxd/src/execution.cpp", "services/metafluxd/src/execution.hpp",
        "services/metafluxd/src/vulkan_execution.cpp", "services/metafluxd/src/vulkan_execution.hpp",
        "services/metafluxd/src/main.cpp", "services/metafluxd/tests/",
    ),
    "compiler-worker-isolation": (
        "services/metafluxd/src/compiler_worker.hpp",
        "services/metafluxd/src/compiler_worker_client.cpp",
        "services/metafluxd/src/compiler_worker_process.cpp",
        "services/metafluxd/src/compiler_worker_protocol.cpp",
        "services/metafluxd/src/compiler_worker_protocol.hpp",
        "services/metafluxd/tests/compiler_worker_test.cpp",
    ),
    "compiler-artifact-cache": (
        "compiler/core/src/cache.cpp", "compiler/core/src/artifact_cache.cpp",
        "compiler/core/include/metaflux/compiler/cache.hpp",
        "compiler/core/include/metaflux/compiler/artifact_cache.hpp",
        "compiler/core/tests/artifact_cache_test.cpp",
    ),
    ...
    "mlir-compiler-engineering": ("plugins/backend/cpu/compiler/", "plugins/backend/vulkan/compiler/"),
