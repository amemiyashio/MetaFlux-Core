...
worker's ordinary candidate goes to [$batch](../../batch/SKILL.md) skill instead. Diagnostic requests remain
...
published revision and observed remote Git `main` revision. Equality proves exact
