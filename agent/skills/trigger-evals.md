...
contract for routed domain skills and the explicit integration, Epoch governance,
and roast workflows. Each skill has positive and near-miss coverage; cross-domain
work is represented by composition cases.
