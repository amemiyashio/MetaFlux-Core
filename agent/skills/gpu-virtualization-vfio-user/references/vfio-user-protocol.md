...
- device reset support and its M0002 terminal semantics;
...
payload length, fd count, integer overflow, range, state, and duplicate request.
Treat received fds as resources requiring close on every error path.
