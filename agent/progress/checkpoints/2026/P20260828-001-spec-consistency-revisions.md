...
| Numeric performance budgets remain provisional for `v0.1.0`; binding requires the `v0.2.0` physical NVIDIA harness and archived baseline | [M0100](../../../plan/M0100-core-foundation/plan.md) |
...
provisional through `v0.1.0`, with binding promotion assigned to the `v0.2.0`
physical NVIDIA harness. M0120 decision 4 now
...
3. The next material boundary is closing the remaining M0100 decisions and the
   ...
   provisional AMD reference evidence); `v0.2.0` owns binding promotion.
