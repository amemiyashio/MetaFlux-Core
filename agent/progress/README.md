...
[`current.md`](current.md) is the replaceable daily resume point. Historical
checkpoints are protected and grouped by year under `checkpoints/YYYY/`.

Latest checkpoint:
[P20260830-005](checkpoints/2026/P20260830-005-semantic-change-distillation-applied.md).
...
the original factual evidence preserved.
