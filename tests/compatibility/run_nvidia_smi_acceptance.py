...
def main() -> int:
    ...
    if (
        ...
        raise RuntimeError("stock-tool manifest family set differs from the frozen milestone-0.1.0.0 matrix")
    ...
    evidence = {
        ...
        "registry_fixture": {
            "kind": "metafluxd-default-milestone-0.1.0.0-single-device",
            "device_count": 1,
            "device": {
                "index": 0,
                "name": EXPECTED_NAME,
