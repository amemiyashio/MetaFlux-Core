 ...
 * Kernel IR construction, and execution remain daemon-owned. */
static const char mf_pytorch_baseline_add_ptx[] =
    ".version 9.0\n"
    ".target sm_70\n"
    ".address_size 64\n"
...
/* The stock-PyTorch int32 tensor-multiply kernel maps to this neutral PTX
 * artifact: the same linear-index copy shape with mul.lo.u32 arithmetic. */
static const char mf_pytorch_baseline_mul_ptx[] =
    ".version 9.0\n"
    ".target sm_70\n"
    ".address_size 64\n"
    ".visible .entry mul_u32(\n"
    "  .param .u64 destination,\n"
    "  .param .u64 left,\n"
    "  .param .u64 right,\n"
    "  .param .u32 count\n"
...
/* The stock-PyTorch float32 tensor-division kernel maps to this neutral PTX
 * artifact: div.rn.f32 over the same linear-index copy shape. */
static const char mf_pytorch_baseline_divf32_ptx[] =
    ".version 9.0\n"
    ".target sm_70\n"
    ".address_size 64\n"
